  ...
  <Panel>
    ...
    <Question title="How does it work?">
      <Typography>
        ...
        paths. Hierarchical deterministic wallets are wallets like Ledger and Trezor devices, and mnemonic phrases, that
        are able to derive many addresses from a single seed. FindETH will search through the most common derivation
        paths, offered by some of the popular wallets.
      </Typography>
      <Typography>
        Currently, FindETH is limited to a fixed set of derivation paths. Custom derivation paths are not supported, but
        support for more derivation paths is planned for the future.
      </Typography>
    </Question>

    <Question title="Can I use my private key or keystore file?">
      <Typography>
        No, private keys and keystore files are not supported, because they are not hierarchical deterministic wallets.
        A private key or keystore file only has a single address, unlike mnemonic phrases and hardware wallets.
      </Typography>
    </Question>
